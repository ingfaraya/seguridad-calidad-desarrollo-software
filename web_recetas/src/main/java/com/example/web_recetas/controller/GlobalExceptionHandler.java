...
public class GlobalExceptionHandler {
    ...
    public String handleNotFound(NoHandlerFoundException ex, Model model) {
        ...
        return "error/404"; // Asegúrate de tener una plantilla "404.html" en la carpeta "templates/error"
    }
    ...
    public String handleUnauthorized(AccessDeniedException ex, Model model) {
        ...
        return "error/401"; // Asegúrate de tener una plantilla "401.html" en la carpeta "templates/error"
    }
    ...
    public String handleServerError(Exception ex, Model model) {
        ...
        return "error/500"; // Asegúrate de tener una plantilla "500.html" en la carpeta "templates/error"
    }
}
